...
herbie_world/
â””â”€â”€ data/
    â”œâ”€â”€ event_log.jsonl      â† Main data file (required)
    â”œâ”€â”€ world_history.txt    â† Human-readable summary
    â””â”€â”€ narrative_log.txt    â† Story of events
```
...
| **Hardy-Weinberg Ï‡Â²** | <3.84 = equilibrium; >3.84 = selection/drift |
