...
# =============================================================================
try:
    # Get the herbie_world package directory (one level up from core/)
    _CORE_DIR = os.path.dirname(os.path.abspath(__file__))
    SCRIPT_DIR = os.path.dirname(_CORE_DIR)  # herbie_world/
...
# File paths - all go in data/ subdirectory for organization
STATE_FILE = os.path.join(DATA_DIR, "herbie_state.npz")
PREFS_FILE = os.path.join(DATA_DIR, "herbie_learned.json")
EVOLUTION_FILE = os.path.join(DATA_DIR, "herbie_evolution.json")
GENERATIONS_DIR = os.path.join(DATA_DIR, "generations")
ANALYTICS_DIR = os.path.join(DATA_DIR, "analytics")
EVENT_LOG_FILE = os.path.join(DATA_DIR, "event_log.jsonl")
HERBIE_MULTI_STATE = os.path.join(DATA_DIR, "herbie_multi_state.npz")
WORLD_STATE_FILE = os.path.join(DATA_DIR, "world_state.npz")
CHEMISTRY_FILE = os.path.join(DATA_DIR, "herbie_chemistry.json")
